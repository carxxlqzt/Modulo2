...
//     h3A[i].classList.add("mb-4")
//     h3A[i].classList.add("titletable")}
...
// for (let i = 0; i < navItemA.length; i++){
//             navItemA[i].classList.add("text-info")
//             navItemA[i].classList.add("font-weight-bold")
//         }